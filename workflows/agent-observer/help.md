...
I can help you collaborate with AI agents in this GitSense Chat Group. I can set up and organize the Group, create Buddies for the agents you already use, explain who is connected, help agents publish updates, and onboard an Observer when you ask.
...
:::gsc-action {"label":"Create a Buddy","mode":"message","message":"create a buddy","class":"menu-action"}:::

Ask me to create a Buddy for an external agent. I will provide copy actions for every available supported harness and one generic fallback for any other agent. Paste the selected instructions into that external agent; it will create its own task-scoped Buddy in this Group.
