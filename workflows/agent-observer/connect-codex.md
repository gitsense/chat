...
Replace `<lead-mailbox-id>` and paste this prompt into Codex.

```md
Run `gsc experts init` so you know how to use the GitSense Chat CLI.

Connect this Codex session to the Agent Observer Group. Collect your current
...
harness: codex
state: queued
summary: Codex is connected and ready to start.
