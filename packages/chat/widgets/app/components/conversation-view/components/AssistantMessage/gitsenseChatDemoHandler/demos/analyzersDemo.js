...
> **Reviewing AI Searches:** All AI Searches in GitSense Chat can be reviewed. After every AI Search, a details section is created which contains links that you can use to review and chat with the LLM with. For example, if you want to verify the distribution numbers in this demo, you can click the 'Review' link in the search results message and it will take you to the chat where the LLM provided its response. What is extremely handy and powerful with this feature is, you may want to view the data in other ways and you can easily do so by chatting with the LLM in the 'Review Chat'.
