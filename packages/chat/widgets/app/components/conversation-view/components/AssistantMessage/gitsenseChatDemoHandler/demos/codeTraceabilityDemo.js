...
let{CodeBlockUtils,ChatUtils,MessageUtils}=require("@gitsense/gsc-utils"),MessageService=require("../../../../services/MessageService"),DEMO_CONSTANTS=require("../constants"),DemoUtils=require("../utils/demoUtils"),DEMO_TITLE="# Code Generation & Traceability Demo",GENERATE_HELLO_WORLD_COMMAND='Generate a "Hello World" program in JavaScript. Before generating the code, acknowledge that you have read the instructions in the system prompt regarding code generation.',CHANGE_HELLO_TO_HEY_COMMAND='Change "Hello" to "Hey" in the JavaScript program and provide a patch. Before generating the patch, acknowledge that you have read the instructions in the system prompt regarding patch generation.',codeTraceabilityDemo={id:"code-traceability",name:"Code Generation & Traceability Demo",description:"Learn how GitSense Chat generates code and provides unparalleled traceability for every AI-assisted change.",scenes:[{id:"code-traceability-intro",action:"typeAndAppend",triggerCondition:(e,t,o,a)=>e.message.includes(DEMO_TITLE),contentToType:`
**Welcome!**
