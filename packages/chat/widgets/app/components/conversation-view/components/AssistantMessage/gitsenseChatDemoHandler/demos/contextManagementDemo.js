...
Ready to get started? We'll first ask AI to find files with spelling mistakes in the 'hello and hey world' repository with the following command:
...
The semantic search found files with spelling mistakes across the "Hello World" and "Hey World" repositories. This demonstrates how you can just chat with an LLM to build a GitSense Chat context.
