...
let tableStyles=`
    ...
    .gsc-table-wrapper {
        --gsc-table-wrapper-max-height: 300px; /* Default max height for scrollable body */
    ...
    .gsc-table-header {
        ...
        border-bottom: 1px solid var(--gsc-table-border-color);
    ...
    /* Animation for highlighting new rows */
    @keyframes gsc-highlight-fade {
        0% {
    ...
    .gsc-table-row-highlight {
        animation: gsc-highlight-fade 3s ease-out forwards;
    }
