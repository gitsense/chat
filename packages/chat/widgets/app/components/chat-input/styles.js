...
.gsc-chat-input-cli-authcode-input.error {
    border-color: #dc3545;
...
/* Claude Code Options */
.gsc-chat-input-claude-code-options {
    display: none;
    width: 100%;
    text-align: left;
...
.gsc-chat-input-claude-code-options.visible {
    display: block;
}

.gsc-chat-input-claude-code-mode-label {
    font-size: 13px;
    color: #666;
    font-weight: 600;
}

.gsc-chat-input-claude-code-help-link {
    color: #444;
    font-size: 14px;
    text-decoration: none;
}

.gsc-chat-input-claude-code-reference-link {
    font-size: 13px;
    color: #444;
    text-decoration: none;
    cursor: pointer;
...
.gsc-chat-input-claude-code-reference-link:hover {
    text-decoration: underline;
}

.gsc-chat-input-claude-code-reference-link.disabled {
    color: #999;
    cursor: default;
}

.gsc-chat-input-claude-code-reference-link.disabled:hover {
    text-decoration: none;
}

/* Claude Code Files List Container */
.gsc-chat-input-claude-code-files-list {
    display: none;
    margin-top: 10px;
    padding: 10px;
...
.gsc-chat-input-claude-code-files-list.visible {
    display: block;
}
...
.gsc-help-tab-pane.active {
    display: block;
}

/* Claude Code Disabled Message */
.gsc-chat-input-claude-code-disabled-message {
...
/* Claude Code Checkbox Options */
.gsc-chat-input-claude-code-checkbox-options {
    display: none;
    gap: 15px;
    align-items: center;
    margin-left: 15px;
...
.gsc-chat-input-claude-code-checkbox-options.visible {
    display: inline-flex;
}

.gsc-chat-input-claude-code-checkbox-wrapper {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
}

.gsc-chat-input-claude-code-checkbox-wrapper input[type="checkbox"] {
    margin-right: 5px;
    vertical-align: middle;
    cursor: pointer;
}

.gsc-chat-input-claude-code-checkbox-wrapper span {
    font-size: 13px;
    vertical-align: middle;
    cursor: pointer;
}
