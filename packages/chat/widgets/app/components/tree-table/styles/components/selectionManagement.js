...
let variables=require("../base/variables"),selectionManagement={treeTableContainer:`
    ...
    `,contextBuilderModal:`
        ...
        .modal-filter-sidebar {
            ...
            min-width: 400px; /* Prevent shrinking - INCREASED FROM 250px */
            display: flex;
        ...
        .context-builder-table .col-name { width: auto; min-width: 400px; padding-left: 5px; line-height: 1.6; } /* Changed to auto */
