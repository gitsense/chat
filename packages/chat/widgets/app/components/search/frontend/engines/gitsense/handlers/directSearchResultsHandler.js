...
\`\`\`txt
${e}
\`\`\``)}catch(e){console.error("Failed to load context builder:",e)}}};var s=r.searchCriteria.isMetaInsights,n=r.searchCriteria.isMetaSearch,c=r.searchCriteria.isEmptySearch,o=r.searchCriteria.keywords?.length;let l;l=s?MetaInsightsResultsRenderer:n||c||!o?TableResultsRenderer:SnippetResultsRenderer;s=h.createDiv({cls:CSS_CLASSES.CONTAINER});s.appendChild(DirectSearchResultsHeader.render(r,t,i));let d=h.createDiv({});if(s.appendChild(d),0===r.totalResultsReturned)d.appendChild(l.render(r,i));else{h.createDiv({});let t=h.createLink({text:"Show Matches",href:"#",style:{fontWeight:600},onclick:e=>{e.preventDefault(),t.remove(),d.innerHTML="",d.appendChild(l.render(r,i))}});n=h.createDiv({text:"Matches are hidden by default until we find the most optimal way to integrate search results into a chat.",style:{fontSize:".9em",marginTop:"5px"}});d.appendChild(t),d.appendChild(h.createBreak()),d.appendChild(n)}return e.appendChild(s),!0}module.exports={handleDirectSearchResults:handleDirectSearchResults};
