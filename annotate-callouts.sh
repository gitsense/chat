...
# Outer radius: 42 + half the white stroke (4) + matching-color outline (2).
OUTER_RADIUS=48
...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <circle cx="${CALLOUT_1_X}" cy="${CALLOUT_1_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_1_COLOR}"/>
  ...
  <circle cx="${CALLOUT_2_X}" cy="${CALLOUT_2_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_2_COLOR}"/>
  ...
  <circle cx="${CALLOUT_3_X}" cy="${CALLOUT_3_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_3_COLOR}"/>
  ...
  <circle cx="${CALLOUT_4A_X}" cy="${CALLOUT_4A_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_4A_COLOR}"/>
  ...
  <circle cx="${CALLOUT_4B_X}" cy="${CALLOUT_4B_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_4B_COLOR}"/>
  ...
  <!--circle cx="${CALLOUT_4C_X}" cy="${CALLOUT_4C_Y}" r="${OUTER_RADIUS}" fill="${CALLOUT_4C_COLOR}"/>
