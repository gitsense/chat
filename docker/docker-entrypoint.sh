...
# Block-UUID: 401acfd0-831f-4bc0-b2d9-96430e7a26c3
# Parent-UUID: 183b418f-ae49-436d-b260-d2f4dbf517a6
# Version: 1.5.0
# Description: Fixed gsc-admin-setup execution by explicitly using 'node' interpreter instead of relying on shebang line, making it more resilient across different environments.
# Language: Bash
# Created-at: 2026-03-19T18:43:31.909Z
# Authors: GLM-4.7 (v1.0.0), GLM-4.7 (v1.1.0), GLM-4.7 (v1.2.0), GLM-4.7 (v1.3.0), Gemini 3 Flash (v1.4.0), GLM-4.7 (v1.5.0)
...
if [ ! -f "${DATA_DIR}/chats.sqlite3" ]; then
    ...
    # Use 'node' explicitly to avoid shebang/permission issues.
    su-exec gitsense node /gsc-docker-app/bin/gsc-admin-setup --data-dir "${DATA_DIR}" --force
