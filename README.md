...
| :--- | :--- |
| **Search finds where words appear.**<br><br>`rg cache`<br><br><img src="assets/readme-rg-without-placeholder.svg" alt="Placeholder for plain rg cache output" width="420"> | **Search returns matches with meaning.**<br><br>`gsc rg cache --db code-intent --fields purpose`<br><br><img src="assets/readme-rg-with-placeholder.svg" alt="Placeholder for gsc rg cache output with purpose metadata" width="420"> |
| **Tree shows paths.**<br><br>`tree crates/ignore/src`<br><br><img src="assets/readme-tree-without-placeholder.svg" alt="Placeholder for plain tree output" width="420"> | **Tree shows paths plus context.**<br><br>`gsc tree --db code-intent --fields purpose --focus crates/ignore/src`<br><br><img src="assets/readme-tree-with-placeholder.svg" alt="Placeholder for gsc tree output with purpose metadata" width="420"> |
| **Docs discovery starts with broad text search.**<br><br>`rg -n -e "extension" -e "extensions" --glob "*.md"`<br><br><img src="assets/readme-docs-without-placeholder.svg" alt="Placeholder for broad Markdown search results" width="420"> | **The Docs Brain returns relevant docs first.**<br><br>`gsc query --db docs --filter "topics=extension" --fields title,summary,section_anchors --limit 6`<br><br><img src="assets/readme-docs-with-placeholder.svg" alt="Placeholder for docs Brain query results" width="420"> |
