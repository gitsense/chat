...
| ![Video placeholder for searching previous agent sessions.](assets/lead-agent-team-building-video-placeholder.svg) | ![Video placeholder for reviewing matched sessions with a lead agent.](assets/lead-agent-team-building-video-placeholder.svg) | ![Video placeholder for investigating which sessions bring the right context.](assets/lead-agent-team-building-video-placeholder.svg) |
...
| ![Video placeholder for updating the team from the lead's roster report.](assets/lead-agent-team-building-video-placeholder.svg) | ![Video placeholder for consulting the updated team on what to know.](assets/lead-agent-team-building-video-placeholder.svg) | ![Video placeholder for starting a new session primed by relevant agents.](assets/lead-agent-team-building-video-placeholder.svg) |
